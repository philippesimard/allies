...
angular.module('users').config(
  ...
  function (UserAuthProvider) {
    ...
    UserAuthProvider.config({
      ...
      authorizedRoutes: ['home', 'userForm', 'propos', 'ressources', 'parcours', 'recherche', 'aide', 'scolaire', 'sante', 'communautaire', 'boite', 'homesante', 'homescolaire', 'homecommunautaire', 'livre', 'document', 'film', 'bd', 'roman', 'confirm_email']
    });
  });
